...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "चिकित्सकीय महत्व", didYouKnow: "क्या आप जानते हैं", viewLesson: "पाठ देखें", quiz: "प्रश्नोत्तरी",
  },
  cards: {
    resources: "{organ} — अध्ययन सामग्री",
    microscopic: "सूक्ष्मदर्शी दृश्य", functionAnimation: "Key parts",
    clinicalNotes: "नैदानिक टिप्पणियाँ", whereItWorks: "कहाँ कार्य करता है", commonConditions: "सामान्य रोग",
    exploreTissue: "ऊतक देखें", playAnimation: "Go through them",
    seeAll: "सभी देखें", seeSystem: "तंत्र देखें",
    playAria: "Go through the key parts of the {organ}", systemAria: "शरीर में {organ} की स्थिति देखें",
  },
