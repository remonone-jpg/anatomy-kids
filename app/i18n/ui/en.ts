...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "Medical importance", didYouKnow: "Did you know", viewLesson: "View lesson", quiz: "Quiz",
  },
  cards: {
    resources: "{organ} learning resources",
    microscopic: "Microscopic view", functionAnimation: "Key parts",
    clinicalNotes: "Clinical notes", whereItWorks: "Where it works", commonConditions: "Common conditions",
    exploreTissue: "Explore tissue", playAnimation: "Go through them",
    seeAll: "See all", seeSystem: "See the system",
    playAria: "Go through the key parts of the {organ}", systemAria: "See where the {organ} sits in the body",
  },
