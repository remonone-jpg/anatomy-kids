...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "Medizinische Bedeutung", didYouKnow: "Wusstest du", viewLesson: "Lektion ansehen", quiz: "Quiz",
  },
  cards: {
    resources: "Lernmaterial: {organ}",
    microscopic: "Mikroskopische Ansicht", functionAnimation: "Key parts",
    clinicalNotes: "Klinische Notizen", whereItWorks: "Wo es wirkt", commonConditions: "Häufige Erkrankungen",
    exploreTissue: "Gewebe erkunden", playAnimation: "Go through them",
    seeAll: "Alle ansehen", seeSystem: "System ansehen",
    playAria: "Go through the key parts of the {organ}", systemAria: "Sehen, wo {organ} im Körper liegt",
  },
