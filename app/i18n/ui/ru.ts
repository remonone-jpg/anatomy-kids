...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "Клиническое значение", didYouKnow: "А вы знали", viewLesson: "Открыть урок", quiz: "Тест",
  },
  cards: {
    resources: "Учебные материалы: {organ}",
    microscopic: "Микроскопия", functionAnimation: "Key parts",
    clinicalNotes: "Клинические заметки", whereItWorks: "Где работает", commonConditions: "Частые заболевания",
    exploreTissue: "Изучить ткань", playAnimation: "Go through them",
    seeAll: "Показать все", seeSystem: "Открыть систему",
    playAria: "Go through the key parts of the {organ}", systemAria: "Посмотреть, где в теле находится {organ}",
  },
