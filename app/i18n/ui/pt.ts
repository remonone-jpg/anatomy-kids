...
export const ui: UiDictionary = {
  ...
  tools: {
    label: "Ferramentas do visualizador 3D", rotate: "Girar", zoom: "Zoom", reset: "Redefinir",
  },
  viewer: {
  ...
  info: {
    ...
    medical: "Importância médica", didYouKnow: "Você sabia", viewLesson: "Ver lição", quiz: "Quiz",
  },
  cards: {
