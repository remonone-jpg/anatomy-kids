...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "医学意义", didYouKnow: "你知道吗", viewLesson: "查看课程", quiz: "测验",
  },
  cards: {
    resources: "{organ}学习资源",
    microscopic: "显微视图", functionAnimation: "Key parts",
    clinicalNotes: "临床要点", whereItWorks: "工作部位", commonConditions: "常见疾病",
    exploreTissue: "探索组织", playAnimation: "Go through them",
    seeAll: "查看全部", seeSystem: "查看该系统",
    playAria: "Go through the key parts of the {organ}", systemAria: "查看{organ}在人体中的位置",
  },
