...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "Importance médicale", didYouKnow: "Le saviez-vous", viewLesson: "Voir la leçon", quiz: "Quiz",
  },
  cards: {
    resources: "Ressources d'apprentissage : {organ}",
    microscopic: "Vue microscopique", functionAnimation: "Key parts",
    clinicalNotes: "Notes cliniques", whereItWorks: "Où il agit", commonConditions: "Affections fréquentes",
    exploreTissue: "Explorer le tissu", playAnimation: "Go through them",
    seeAll: "Tout voir", seeSystem: "Voir le système",
    playAria: "Go through the key parts of the {organ}", systemAria: "Voir où se situe {organ} dans le corps",
  },
