...
export const ui: UiDictionary = {
  ...
  info: {
    ...
    medical: "Importancia médica", didYouKnow: "¿Sabías que…?", viewLesson: "Ver lección", quiz: "Cuestionario",
  },
  cards: {
    resources: "Recursos de aprendizaje: {organ}",
    microscopic: "Vista microscópica", functionAnimation: "Key parts",
    clinicalNotes: "Notas clínicas", whereItWorks: "Dónde actúa", commonConditions: "Enfermedades frecuentes",
    exploreTissue: "Explorar el tejido", playAnimation: "Go through them",
    seeAll: "Ver todas", seeSystem: "Ver el sistema",
    playAria: "Go through the key parts of the {organ}", systemAria: "Ver dónde se sitúa {organ} en el cuerpo",
  },
