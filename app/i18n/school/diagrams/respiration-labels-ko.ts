...
export const respirationLabels: DiagramLabel[] = [
  ...
  { id: "vocal-folds", label: "성대주름", name: "성대주름", related: ["larynx", "thyroid-cartilage"],
    ...
    desc: "후두 안에 좌우로 마주 보고 있는 두 겹의 주름이에요. 숨 쉴 때는 벌어져 공기가 지나가고, 소리를 낼 때는 가까이 모여 그 틈으로 공기가 빠져나가며 떨립니다. 팽팽하게 당기면 빠르게 떨려 높은 소리, 느슨하면 천천히 떨려 낮은 소리가 나요. 목이 쉬는 것은 이 주름이 부어 제대로 붙지 못하기 때문입니다. 그래서 말은 보통 숨을 내쉬면서 하게 돼요." },
  ...
  { id: "right-superior-lobe", label: "오른위엽", name: "오른위엽", related: ["right-lung", "right-middle-lobe", "horizontal-fissure"],
    ...
    desc: "오른폐의 맨 위 부분이에요. 아래로 수평틈새를 경계로 중간엽과 나뉩니다. 폐 꼭대기는 빗장뼈보다 조금 위까지 올라가 있어서, 목 아래쪽까지 폐가 뻗어 있는 셈이에요. 서 있을 때는 중력 때문에 공기도 피도 아래쪽으로 더 많이 갑니다. 다만 피가 훨씬 더 많이 몰리기 때문에, 들어온 공기를 알뜰하게 쓰는 정도로 보면 오히려 꼭대기 쪽이 앞섭니다." },
  ...
  { id: "left-apex", label: "허파꼭대기", name: "허파꼭대기", related: ["left-lung", "left-superior-lobe"],
    descEasy: "폐의 맨 위 끝이에요. 양쪽 폐에 다 있는데, 그림에서는 왼쪽에만 표시했어요. 빗장뼈보다 조금 위까지 올라가 있어서, 목 아래쪽까지 폐가 뻗어 있는 셈이에요.",
    desc: "폐의 맨 위 끝이에요. 양쪽 폐 모두 꼭대기가 있는데, 그림에서는 왼쪽에 표시했어요. 빗장뼈보다 2~3센티미터 위까지 올라가 있어서, 목 아래쪽까지 폐가 뻗어 있는 셈입니다. 가슴 안이 아니라 목 아래에 있는 셈이라, 이 부위를 다치면 공기가 새어 폐가 쪼그라들 수 있어요. 서 있을 때는 중력 때문에 이곳으로 가는 피가 적어 기체 교환이 상대적으로 덜 일어납니다." },
  ...
  { id: "alveolar-atrium", label: "허파꽈리방", name: "허파꽈리방", related: ["alveolar-duct", "alveolar-sacs", "alveoli"],
    ...
    desc: "허파꽈리관과 허파꽈리주머니 사이의 작은 공간이에요. 여러 주머니로 갈라지기 직전의 대기실 같은 자리입니다. 이름이 심장의 심방과 같지만 전혀 다른 것으로, 여기서는 허파꽈리 구조의 일부예요. 라틴어로 집 한가운데 뚫린 '안뜰'이라는 뜻이라 두 곳에 같은 이름이 붙었습니다." },
