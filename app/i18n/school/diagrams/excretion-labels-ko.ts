...
export const excretionLabels: DiagramLabel[] = [
  {
    ...
    organId: "kidneys",
    related: ["ureter"],
    crossSystem: { systemId: "circulation", labelId: "renal", reason: "콩팥은 피를 거르는 기관이라 콩팥동맥으로 엄청난 양의 피를 받습니다. 심장이 내보내는 피의 5분의 1이 넘어요." },
  ...
  },
  {
    ...
    crossSystem: { systemId: "movement", labelId: "lumbar", reason: "오줌관이 허리뼈 앞을 따라 내려갑니다. 콩팥에서 방광까지 가는 길이 척추와 나란해요." },
  ...
  },
  {
    ...
    crossSystem: { systemId: "movement", labelId: "pelvis", reason: "골반이 대야처럼 방광을 아래에서 받쳐 줍니다. 오줌이 차면 이 공간 안에서 방광이 부풀어요." },
  ...
  },
  {
    ...
    name: "요도",
    related: ["bladder"],
    crossSystem: { systemId: "digestion", labelId: "anus", reason: "요도와 항문은 조임근이 두 겹이라는 구조가 같습니다. 하나는 저절로 닫히고 하나는 마음대로 조절할 수 있어요." },
