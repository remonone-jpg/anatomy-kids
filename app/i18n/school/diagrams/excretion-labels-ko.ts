...
export const excretionLabels: DiagramLabel[] = [
  {
    ...
    organId: "kidneys",
    related: ["ureter"],
    crossSystem: { systemId: "circulation", labelId: "renal", reason: "콩팥은 피를 거르는 기관이라 콩팥동맥으로 엄청난 양의 피를 받습니다. 심장이 내보내는 피의 5분의 1이 넘어요.", reasonEasy: "콩팥은 피를 거르는 곳이라 아주 많은 피를 받아요. 심장이 내보내는 피의 5분의 1이 넘어요." },
    descEasy: "피 속의 찌꺼기를 걸러서 오줌을 만드는 기관이에요. 등 쪽 허리 부근에 좌우 하나씩 있고, 강낭콩 모양에 주먹보다 조금 작아요. 안에는 피를 거르는 아주 작은 거름망이 백만 개나 들어 있어요. 심장이 내보내는 피의 5분의 1이 넘게 이곳으로 와요.",
  ...
  },
  {
    ...
    crossSystem: { systemId: "movement", labelId: "lumbar", reason: "오줌관이 허리뼈 앞을 따라 내려갑니다. 콩팥에서 방광까지 가는 길이 척추와 나란해요.", reasonEasy: "오줌관이 허리뼈 앞을 따라 내려가요." },
    descEasy: "콩팥에서 만든 오줌을 방광까지 내려보내는 가느다란 관이에요. 오줌이 저절로 흘러내리는 게 아니라 관이 조금씩 밀어 내려 줘요.",
  ...
  },
  {
    ...
    crossSystem: { systemId: "movement", labelId: "pelvis", reason: "골반이 대야처럼 방광을 아래에서 받쳐 줍니다. 오줌이 차면 이 공간 안에서 방광이 부풀어요.", reasonEasy: "골반이 대야처럼 방광을 아래에서 받쳐 줘요." },
    descEasy: "오줌을 잠시 모아 두는 주머니예요. 풍선처럼 늘어났다 줄어들어요. 어느 정도 차면 뇌에 '마려워요' 하고 신호를 보내요.",
  ...
  },
  {
    ...
    name: "요도",
    related: ["bladder"],
    crossSystem: { systemId: "digestion", labelId: "anus", reason: "요도와 항문은 조임근이 두 겹이라는 구조가 같습니다. 하나는 저절로 닫히고 하나는 마음대로 조절할 수 있어요.", reasonEasy: "요도와 항문은 근육이 두 겹인 게 똑같아요. 하나는 저절로, 하나는 마음대로 조절해요." },
    descEasy: "방광에 모인 오줌이 몸 밖으로 나가는 마지막 길이에요. 평소에는 근육이 조여 닫혀 있다가 화장실에서 힘을 빼면 열려요. 그래서 오줌을 참을 수 있어요.",
